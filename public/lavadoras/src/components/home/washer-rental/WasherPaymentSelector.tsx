    ...
    <div className="space-y-4 pt-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          ...
          <Wallet className={cn("w-7 h-7", paymentMethod === 'cash' ? "text-yellow-500 animate-pulse" : "text-slate-300")} />
        ...
        >
          ...
          <Globe className={cn("w-7 h-7", paymentMethod === 'digital' ? "text-slate-900" : "text-slate-300")} />
