    ...
    <section className="animate-in slide-in-from-right-4 duration-500 -mx-6 -mt-2">
      <Card className="border-none rounded-[32px] bg-white shadow-2xl overflow-hidden ring-1 ring-black/[0.03] mx-4">
        <div className="p-6 space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={cn(
                  ...
                  {paymentMethod === 'cash' ? 'Efectivo' : 'Pago Digital'}
                </p>
              </div>
            </div>
            <Badge className={cn(
              "px-4 py-2 rounded-full font-black text-[10px] uppercase tracking-wider",
              paymentMethod === 'cash' 
                ? "bg-emerald-50 text-emerald-600 border border-emerald-200" 
                : "bg-blue-50 text-blue-600 border border-blue-200"
            )}>
              {paymentMethod === 'cash' ? `Cobrar: ${formattedPrice}` : 'Sin cobro'}
            </Badge>
          </div>
          ...
          <div className="flex items-center justify-between bg-slate-50 rounded-2xl p-4 border border-slate-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-black text-slate-800 italic tracking-tighter">#{orderCode}</p>
              </div>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-xl border border-slate-200 shadow-sm">
              <Timer className="w-4 h-4 text-slate-400" />
              <span className="text-sm font-black text-slate-700 italic">{requestHours || 5}h</span>
            </div>
          </div>
          ...
          <Collapsible className="rounded-2xl bg-slate-50 border border-slate-200 overflow-hidden" defaultOpen={true}>
