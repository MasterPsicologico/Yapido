...
export function DurationManager({
  requestHours, onAdjust, minHours, formattedPrice, flashEffect
        ...
        <div className="flex items-center gap-6 w-full justify-between relative z-10">
          ...
          <div className="text-center flex flex-col items-center">
            <div className="flex items-center justify-center py-4">
              <span className={cn(
                "text-6xl font-black italic tracking-tighter transition-all duration-500 text-transparent bg-clip-text leading-[1.2] block min-w-[80px] px-2 text-center",
