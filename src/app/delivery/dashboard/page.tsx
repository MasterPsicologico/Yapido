                  ...
                  <Card key={order.id} className="border-none rounded-[40px] shadow-2xl overflow-hidden bg-white ring-1 ring-black/5">
                    ...
                    <CardContent className="p-10 space-y-8">
                      ...
                      <div className="grid grid-cols-1 gap-3">
                        <Button className="h-16 rounded-[24px] bg-slate-900 text-white font-black uppercase tracking-widest gap-3 shadow-xl">
                          <MapIcon className="w-6 h-6 text-primary" /> GPS TIENDA
                        </Button>
                        <Button className="h-16 rounded-[24px] bg-secondary text-white font-black uppercase tracking-widest gap-3 shadow-xl shadow-secondary/20">
                          <CheckCircle2 className="w-6 h-6" /> HE LLEGADO
                        </Button>
                      </div>
                    </CardContent>
                  </Card>
