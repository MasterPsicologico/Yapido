...
import { ShoppingCart, ArrowLeft, Heart, Share2, Loader2, MessageCircle, Minus, Plus, CheckCircle2 } from 'lucide-react';
...
export default function ProductPage() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      toast({ title: "¡Pedido Solicitado!", description: "El vendedor ha sido notificado." });
    } catch (e) {
          ...
          <div className="p-8 md:p-12 flex flex-col">
            ...
            {orderConfirmed ? (
              <div className="bg-green-50 border border-green-100 p-6 rounded-3xl flex flex-col items-center text-center gap-3 animate-in zoom-in duration-300">
                ...
                <p className="text-green-700 text-sm font-medium">Hemos registrado tu solicitud. El vendedor se pondrá en contacto pronto.</p>
                <Link href="/" className="mt-2 w-full">
                  <Button className="w-full rounded-full font-bold">Seguir Vitrineando</Button>
                </Link>
              </div>
            ) : (
              <div className="mt-auto space-y-6 pt-8 border-t border-slate-100">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Button 
                    size="lg"
                    className="w-full h-14 rounded-full text-lg font-black gap-3 bg-[#25d366] hover:bg-[#128c7e] text-white shadow-lg border-none"
                  >
