                ...
                <Card key={order.id} id={order.id} className="border-none rounded-[48px] overflow-hidden shadow-2xl bg-white border border-slate-50">
                  <CardContent className="p-8 space-y-6">
                    <div className="flex flex-wrap items-center gap-3">
                      <Badge className={cn("text-white border-none rounded-full px-6 h-10 text-[10px] font-black uppercase tracking-widest", isVenta ? "bg-secondary" : "bg-primary")}>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-3">
                          ...
                          <Link 
                            ...
                            className="text-base font-black text-slate-800 hover:text-primary transition-colors"
                          >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-base font-black text-slate-800 italic">WhatsApp Cliente</span>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4 pt-4">
                      ...
                      <Button 
                        ...
                        className="w-full h-18 rounded-full bg-[#22c55e] hover:bg-[#16a34a] text-white font-black text-lg uppercase tracking-widest gap-3 shadow-xl shadow-green-100 border-none transition-transform active:scale-95"
                      >
                      ...
                      <Button 
                        ...
                        className="w-full h-10 rounded-full text-slate-300 font-black text-[9px] uppercase tracking-[0.3em] hover:bg-slate-50 transition-colors"
                      >
      ...
      <Dialog open={!!selectedOrderForChat} onOpenChange={(v) => !v && setSelectedOrderForChat(null)}>
        <DialogContent className="p-0 border-none bg-transparent shadow-none max-w-[450px]">
          <DialogHeader className="sr-only">
            <DialogTitle>Chat de Pedido</DialogTitle>
            <DialogDescription>Conversación en vivo para gestionar los detalles de este pedido.</DialogDescription>
          </DialogHeader>
